...
const styles = StyleSheet.create({
  ...
  header: { padding: SPACING.base, paddingTop: SPACING.md, backgroundColor: '#FFF', borderBottomWidth: 1, borderBottomColor: COLORS.border },
  headerTitle: { fontSize: TYPOGRAPHY.fontSize.xl, fontWeight: 'bold', color: COLORS.textPrimary, textAlign: 'center' },
