...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, ActivityIndicator, FlatList, Alert, Modal, RefreshControl, TextInput } from 'react-native';
...
export default function OrderTestPage() {
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            >
                {loading && <ActivityIndicator size="large" color="#4F46E5" style={{ marginVertical: 20 }} />}
