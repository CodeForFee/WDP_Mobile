...
export const CreateClaimBody = z.object({
    shipmentId: z.string().uuid("Shipment ID không hợp lệ"),
    ...
    items: z.array(z.object({
        ...
        imageProofUrl: z.union([z.string().url("Link ảnh không hợp lệ"), z.string()]).optional()
    }))
});
...
export type CreateClaimInput = CreateClaimBodyType;
export type ClaimItemInput = CreateClaimBodyType['items'][number];
